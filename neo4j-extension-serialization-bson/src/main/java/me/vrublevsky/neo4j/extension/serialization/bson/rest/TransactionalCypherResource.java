package me.vrublevsky.neo4j.extension.serialization.bson.rest;

import me.vrublevsky.neo4j.extension.serialization.bson.BsonSerialize;
...
public class TransactionalCypherResource {
    ...
    public StreamingOutput executeStatementsAndCommit(InputStream input) {
        BsonSerialize serializer = new BsonSerialize(facade.deserializer(input), db, executionEngine);
